...
constructor TFigT.Create(color: TColor; row, col: byte; size: byte);
begin
  ...
  cubes_[2][0] := TCube.Create(color_, 0, 1, size_);
  ...
  cubes_[3][2] := TCube.Create(color_, 1, 1, size_);
  cubes_[3][3] := TCube.Create(color_, 2, 0, size_);
end;
